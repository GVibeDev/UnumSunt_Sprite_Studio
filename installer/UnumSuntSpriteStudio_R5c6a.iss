...
OutputBaseFilename=UnumSunt_Sprite_Studio_R5c6a_Setup_x64
...
Name: "complete"; Description: "Completa R5c6a · Core + runtime AI + Wan Animate + Krea 2 Turbo"
...
begin
  ...
  PreflightReport := SetupReportDir + '\runtime_preflight_R5c6a.json';
  AdoptionReport := SetupReportDir + '\runtime_adoption_R5c6a.json';
  InstallReport := SetupReportDir + '\runtime_install_R5c6a.json';
  HealthReport := SetupReportDir + '\runtime_health_R5c6a.json';
...
begin
  ...
  ReportPath := ExpandConstant('{tmp}\UnumSunt_R5c6a_uninstall_cleanup.json');
