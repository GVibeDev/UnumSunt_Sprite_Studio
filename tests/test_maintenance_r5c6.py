...
class MaintenanceR5c6Tests(unittest.TestCase):
    ...
    def test_build_script_targets_r5c6_setup(self) -> None:
        ...
        self.assertIn("installer\\UnumSuntSpriteStudio_R5c6.iss", text)
        self.assertIn("UnumSunt_Sprite_Studio_R5c6_Setup_x64.exe", text)
