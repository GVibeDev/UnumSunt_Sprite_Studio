...
class R5c4SetupTests(unittest.TestCase):
    def test_inno_script_defines_core_complete_custom_types(self) -> None:
        ...
        self.assertIn('Name: "complete"; Description: "Complete', script)
        self.assertIn('Name: "custom"; Description: "Custom"; Flags: iscustom', script)
    ...
    def test_setup_build_builds_standalone_before_inno(self) -> None:
        ...
        self.assertIn('UnumSunt_Sprite_Studio_R5c8_Setup_x64.exe', script)
