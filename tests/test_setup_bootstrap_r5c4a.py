...
class SetupBootstrapR5c4aTests(unittest.TestCase):
    ...
    def test_r5c4a_installer_contract(self):
        self.assertIn("UnumSuntSpriteStudio_R5c8.iss", self.script)
        self.assertIn("UnumSunt_Sprite_Studio_R5c8_Setup_x64.exe", self.script)
        self.assertTrue((self.root / "installer" / "UnumSuntSpriteStudio_R5c8.iss").is_file())
